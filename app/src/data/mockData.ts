...
export const cityData: Record<string, { aqi: number; temp: number; wind: number; ozone: number; fire: number; sea: number; co2: number; ice: number }> = {
...
export const damByCity: Record<string, { name: string; level: number }> = {
